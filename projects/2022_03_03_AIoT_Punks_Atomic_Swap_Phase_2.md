# *2022_03_03_AIoT_Punks_Atomic_Swap_Phase_2*

* Project Name: *2022_03_03_AIoT_Punks_Atomic_Swap_Phase_2*
...
* Projected effort: *2.19 person/months*
* Pre-project effort: *e.g. 0.55 person/months*
* Requested USDC PKT equivalent contribution: *20,160 USDC*
...
A patch for the Bitcoin Electrum wallet, and the PKT Electrum wallet, to allow swaps with the HTLC process as described here:
https://github.com/bitcoin/bips/blob/master/bip-0199.mediawiki
The patch should allow to perform the following actions:
create the preimage and digest
create the HTLC script and P2SH address
...
There is already a set of tools to perform atomic swaps with the Electrum wallet from the command line:
https://github.com/robvanmieghem/electrumatomicswap
This will be integrated in both wallets with an easy to use GUI.

SUCCESS CRITERIA

Successful HTLC transfer between BTC/PKT in both directions, and unsuccessful transfer in both directions, with money recovery after the timeout, with the Electrum wallets. Tested on the testnets of PKT and BTC.
...
#### Payout
After the project is accepted, the Network Steward will pay the PKT equivalent of 4,032 USDC (1/5 of the project budget)

### Milestone 1


1)Successful HTLC transfer between BTC/PKT in both directions, and unsuccessful transfer in both directions, with money recovery after the timeout, with the command line program. Tested on the testnets of PKT and BTC.



#### Payout
After a report is delivered on this milestone and it is approved by the NS, the NS will send the PKT equivalent of 16,128 USDC (4/5 of the project budget)
