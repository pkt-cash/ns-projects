...
## Project Status
 ...
 - [x] Milestone 1 payment requested  
   - `51,027 PKT` for `467.5 EUR` i.e. `467.5 EUR / ( 0.90 EUR / USD * 0.0088 USD / PKT )`
     ...
     * June 10, 2022: Payment (refund) executed in transaction: [1](https://explorer.pkt.cash/tx/3c79bc9a04b9dac1be332540d818de4b9359d0d6355a527999c230e96b9d1876)
 ...
 - [x] Milestones 2 through 9 payment requested
   ...
   - June 10, 2022: Payment executed in transactions:
